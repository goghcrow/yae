...
var (
	...
	MAX_NUM_NUM = val.Fun(
		types.Fun(MAX, []*types.Type{types.Num, types.Num}, types.Num),
	...
	MAX_LIST = val.Fun(
		types.Fun(MAX, []*types.Type{types.List(types.Num)}, types.Num),
		func(args ...*val.Val) *val.Val {
			lst := args[0].List().V
			if len(lst) == 0 {
				return val.Num(0)
	...
	MIN_NUM_NUM = val.Fun(
		types.Fun(MIN, []*types.Type{types.Num, types.Num}, types.Num),
		func(args ...*val.Val) *val.Val {
	...
	MIN_LIST = val.Fun(
		types.Fun(MIN, []*types.Type{types.List(types.Num)}, types.Num),
		func(args ...*val.Val) *val.Val {
			lst := args[0].List().V
			if len(lst) == 0 {
				return val.Num(0)
	...
	// ABS_NUM abs :: num -> num
	ABS_NUM = val.Fun(
		types.Fun(ABS, []*types.Type{types.Num}, types.Num),
		func(args ...*val.Val) *val.Val {
	...
	CEIL_NUM = val.Fun(
		types.Fun(CEIL, []*types.Type{types.Num}, types.Num),
		func(args ...*val.Val) *val.Val {
	...
	FLOOR_NUM = val.Fun(
		types.Fun(FLOOR, []*types.Type{types.Num}, types.Num),
		func(args ...*val.Val) *val.Val {
	...
	ROUND_NUM = val.Fun(
		types.Fun(ROUND, []*types.Type{types.Num}, types.Num),
		func(args ...*val.Val) *val.Val {
